...
(function($,W,D)
{
    ...
    W.JQUERY4U.WIDGETS.TWITTER = {
        ...
        init: function(wid)
        {
            ...
            //  $.getJSON("http://search.twitter.com/search.json?q=newyear&rpp=5&callback=?", function(data)
            $.getJSON("http://search.twitter.com/search.json?q=" + wid + "&rpp=100&page=10&callback=?", function(data)
            {
